  ...
  return (
    <div className='flex flex-row flex-wrap justify-evenly items-center w-full space-y-6'>
        {Object.entries(categoryData).map(([category, skills], index) => (
            <div key={index} className='h-contrast:bg-black h-contrast:border-yellow-h-contrast bg-white dark:bg-dark border-3 border-black shadow-[10px_10px_0px_0px_black] p-2 rounded-lg shadow-gray-400 transform hover:scale-105 transition duration-300 text-center'>
