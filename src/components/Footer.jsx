...
const Footer = () => {
  ...
  return (
    <div className='text-center space-y-3'>
            ...
            <article className="h-contrast:bg-h-contrast h-contrast:border-yellow-h-contrast h-contrast:border-2 p-4 text-center mx-auto lg:max-w-1/2 bg-gray-200 rounded-lg relative overflow-hidden dark:text-gray-800">
            ...
            <div className='flex flex-row justify-center list-none gap-8 mb-4'>
              ...
              <a className="h-contrast:bg-yellow-h-contrast h-contrast:rounded-full w-8 h-8 h-contrast:outline-2" href="mailto:domanska.dev@gmail.com">
