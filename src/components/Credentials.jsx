...
const Credentials = () => {
  ...
  return (
    <div className=' text-center h-contrast:shadow-[0px_-6px_0px_0px_rgba(251, 231, 9, 0.958)] shadow-[0px_-6px_0px_0px_rgba(0,0,0,0.1)] dark:max-w-screen-xl mx-auto font-family-fira-code scroll-pt-16 dark:bg-gray-800 dark:text-white'>
            <footer className="h-contrast:bg-h-contrast h-contrast:text-yellow-h-contrast bg-dark text-gray-200 text-sm text-center py-4 px-0 mx-0">
